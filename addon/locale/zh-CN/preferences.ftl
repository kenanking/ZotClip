...
pref-multi-attachment-mode-all = 复制所有允许的附件
pref-multi-attachment-mode-primary = 仅复制主要的允许附件
...
pref-reader-ctrl-c-mode-smart = 智能（选中文本时复制文本）
pref-reader-ctrl-c-mode-never = 从不拦截 Ctrl+C
pref-reader-ctrl-c-mode-always = 始终复制当前附件文件
